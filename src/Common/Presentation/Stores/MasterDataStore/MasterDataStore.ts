...
export class MasterDataStore implements MasterDataStoreState {
    ...
    constructor(
        ...
        @inject(GetSuppliersUseCase) private readonly getSuppliersUseCase: GetSuppliersUseCase,
        @inject(GetGoodsUseCase) private readonly getGoodsUseCase: GetGoodsUseCase
    ) {
    ...
    async loadCategories() {
        ...
        try {
            ...
            runInAction(() => {
                this.categories.error = error instanceof Error 
                    ? error.message 
    ...
    async loadUnits() {
        ...
        try {
            ...
            runInAction(() => {
                this.units.error = error instanceof Error 
                    ? error.message 
    ...
    async loadSuppliers() {
        ...
        try {
            ...
            runInAction(() => {
                this.suppliers.error = error instanceof Error 
                    ? error.message 
    ...
    async loadGoods() {
        ...
        try {
            ...
            runInAction(() => {
                this.goods.error = error instanceof Error 
                    ? error.message 
